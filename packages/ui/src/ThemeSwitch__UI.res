...
let make = () => {
  ...
  <div className="flex items-center space-x-4">
    <svg width="32" height="32" fill="none">
      ...
      <defs>
        <linearGradient
          id="paint0_linear" x1="2" y1="2" x2="30" y2="30" gradientUnits="userSpaceOnUse">
    ...
    <Switch__Headless
      ...
      className={`inline-flex items-center px-0.5 rounded-full w-18 h-9 ${enabled
          ? "justify-end"
          : ""} ${enabled ? "backgroundColor: #000" : "backgroundColor: #60D360"}`}>
      {_ => <>
        <span className="sr-only"> {React.string("Enable dark mode")} </span>
        // <motion.span
        //   layout
