...
function Make(CssImpl) {
  ...
  var merge3 = function (s, s2, s3) {
    return merge([s, s2, s3]);
  };
  var merge4 = function (s, s2, s3, s4) {
    return merge([s, s2, s3, s4]);
  };
...
function backdropFilter(x) {
  return {
    ...
    _1: join(
      Belt_Array.map(
        x,
        Css_AtomicTypes$IsenseiMonorepo.BackdropFilter.toString
      ),
      ", "
    ),
  };
...
function borderRadius4(topLeft, topRight, bottomLeft, bottomRight) {
  return {
    ...
    _0: "borderRadius",
    _1:
      Css_AtomicTypes$IsenseiMonorepo.Length.toString(topLeft) +
      (" " +
        (Css_AtomicTypes$IsenseiMonorepo.Length.toString(topRight) +
          (" " +
            (Css_AtomicTypes$IsenseiMonorepo.Length.toString(bottomLeft) +
              (" " +
                Css_AtomicTypes$IsenseiMonorepo.Length.toString(
                  bottomRight
                )))))),
  };
}
...
function transforms(x) {
  return {
    ...
    _0: "transform",
    _1: join(
      Belt_Array.map(x, Css_AtomicTypes$IsenseiMonorepo.Transform.toString),
      " "
    ),
  };
}
...
function backgrounds(x) {
  return {
    ...
    _0: "background",
    _1: join(
      Belt_Array.map(x, function (item) {
...
function strokeDasharray(x) {
  return {
    ...
    _1:
      typeof x === "object"
        ? join(Belt_Array.map(x.VAL, string_of_dasharray), " ")
        : "none",
  };
}
