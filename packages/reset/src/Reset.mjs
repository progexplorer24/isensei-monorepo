...
function addReset(param) {
  ...
  CssJs$IsenseiMonorepo.$$global("b, strong", [
    CssJs$IsenseiMonorepo.fontWeight("bolder"),
  ]);
  ...
  CssJs$IsenseiMonorepo.$$global("small", [
    CssJs$IsenseiMonorepo.fontSize({
      NAME: "percent",
      VAL: 80,
    }),
  ...
  CssJs$IsenseiMonorepo.$$global("sup", [
  ...
  CssJs$IsenseiMonorepo.$$global("button,\n  select", [
    CssJs$IsenseiMonorepo.textTransform("none"),
  ]);
  CssJs$IsenseiMonorepo.$$global(
    "button,\n  [type='button'],\n  [type='reset'],\n  [type='submit']",
  ...
  CssJs$IsenseiMonorepo.$$global(":-moz-focusring", [
    CssJs$IsenseiMonorepo.unsafe("outline", "1px dotted ButtonText"),
  ]);
  CssJs$IsenseiMonorepo.$$global(":-moz-ui-invalid", [
    CssJs$IsenseiMonorepo.boxShadow("none"),
  ]);
  CssJs$IsenseiMonorepo.$$global("legend", [
    CssJs$IsenseiMonorepo.padding("zero"),
  ]);
  CssJs$IsenseiMonorepo.$$global("progress", [
    CssJs$IsenseiMonorepo.verticalAlign("baseline"),
  ]);
  CssJs$IsenseiMonorepo.$$global(
  ...
  CssJs$IsenseiMonorepo.$$global("::-webkit-search-decoration", [
    CssJs$IsenseiMonorepo.unsafe("WebkitAppearance", "none"),
  ]);
  CssJs$IsenseiMonorepo.$$global("::-webkit-file-upload-button", [
    CssJs$IsenseiMonorepo.unsafe("WebkitAppearance", "button"),
    CssJs$IsenseiMonorepo.unsafe("font", "inherit"),
  ]);
  CssJs$IsenseiMonorepo.$$global("summary", [
    CssJs$IsenseiMonorepo.display("listItem"),
  ]);
  CssJs$IsenseiMonorepo.$$global(
    "blockquote,\n  dl,\n  dd,\n  h1,\n  h2,\n  h3,\n  h4,\n  h5,\n  h6,\n  hr,\n  figure,\n  p,\n  pre",
    [CssJs$IsenseiMonorepo.margin("zero")]
  ...
  CssJs$IsenseiMonorepo.$$global("textarea", [
    CssJs$IsenseiMonorepo.resize("vertical"),
  ]);
  CssJs$IsenseiMonorepo.$$global(
  ...
  CssJs$IsenseiMonorepo.$$global('button,\n  [role="button"]', [
    CssJs$IsenseiMonorepo.cursor("pointer"),
  ]);
  CssJs$IsenseiMonorepo.$$global("table", [
    CssJs$IsenseiMonorepo.borderCollapse("collapse"),
  ]);
