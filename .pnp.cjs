...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      ...
      {
        "name": "rescript-config",
        "reference": "workspace:packages/rescript-config"
      }
    ],
    "enableTopLevelFallback": true,
    "ignorePatternData": "(^(?:\\.yarn\\/sdks(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$)",
    "fallbackExclusionList": [
      ["isensei-monorepo", ["workspace:."]],
      ["rescript-config", ["workspace:packages/rescript-config"]]
    ],
    "fallbackPool": [
    ],
    "packageRegistryData": [
      ...
      ["rescript-config", [
        ["workspace:packages/rescript-config", {
          "packageLocation": "./packages/rescript-config/",
          "packageDependencies": [
            ["rescript-config", "workspace:packages/rescript-config"],
            ["rescript", "npm:9.1.4"]
          ],
      ...
      ["turbo", [
        ["npm:1.0.19", {
          "packageLocation": "./.yarn/unplugged/turbo-npm-1.0.19-2d2e11d4d0/node_modules/turbo/",
          "packageDependencies": [
            ["turbo", "npm:1.0.19"]
          ],
          "linkType": "HARD",
