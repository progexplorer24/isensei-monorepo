...
Cypress$IsenseiMonorepo.context("Location", function (param) {
  ...
  Cypress$IsenseiMonorepo.it(
    ...
    function (param) {
      cy.location(undefined).should(function (locObject) {
        ...
        Cypress$IsenseiMonorepo.expect(locObject.href).equal(
          "https://example.cypress.io/commands/location"
        );
        Cypress$IsenseiMonorepo.expect(locObject.host).equal(
          "example.cypress.io"
        );
        Cypress$IsenseiMonorepo.expect(locObject.hostname).equal(
          "example.cypress.io"
        );
        Cypress$IsenseiMonorepo.expect(locObject.origin).equal(
          "https://example.cypress.io"
        );
        Cypress$IsenseiMonorepo.expect(locObject.pathname).equal(
          "/commands/location"
        );
  ...
  return Cypress$IsenseiMonorepo.it(
    ...
    function (param) {
      return Cypress$IsenseiMonorepo.shouldEqualString(
        cy.url(undefined),
        "https://example.cypress.io/commands/location"
      );
    }
