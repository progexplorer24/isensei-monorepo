...
Cypress$IsenseiMonorepo.context("Files", (function (param) {
        ...
        Cypress$IsenseiMonorepo.beforeEach(function (param) {
              cy.fixture("example.json", undefined, Cypress$IsenseiMonorepo.FixtureOptions.make(undefined, undefined)).as("example");
        ...
        Cypress$IsenseiMonorepo.it("cy.fixture() - load a fixture", (function (param) {
                ...
                return Cypress$IsenseiMonorepo.andInclude(Cypress$IsenseiMonorepo.shouldHavePropertyP(cy.wait("@getComment", undefined).its("response.body", undefined), "name"), "Using fixtures to represent data");
              }));
        Cypress$IsenseiMonorepo.it("cy.readFile() - read file contents", (function (param) {
        ...
        return Cypress$IsenseiMonorepo.it("cy.writeFile() - write to a file", (function (param) {
                      ...
                      cy.fixture("users", undefined, undefined).should(function (response) {
                            ...
                            console.log(users);
                            Cypress$IsenseiMonorepo.expect(Caml_array.get(users, 0).name).equal("Leanne Graham");
