...
Cypress$IsenseiMonorepo.describe("My First link visit", (function (param) {
        return Cypress$IsenseiMonorepo.it("Visits the Kitchen Sink", (function (param) {
                      cy.visit("https://example.cypress.io", undefined);
                      cy.pause(undefined);
                      cy.contains(undefined, "type", undefined).click(undefined);
                      Cypress$IsenseiMonorepo.shouldInclude(cy.url(undefined), "/commands/actions");
                      return Cypress$IsenseiMonorepo.shouldHaveValue(cy.get(".action-email", undefined).type("fake@email.com", undefined), "fake@email.com");
                    }));
      }));
