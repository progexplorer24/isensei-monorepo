...
Cypress$IsenseiMonorepo.context("Local Storage", function (param) {
  ...
  return Cypress$IsenseiMonorepo.it(
    ...
    function (param) {
      cy.get(".ls-btn", undefined)
        .click(undefined)
        .should(function (_el) {
          Cypress$IsenseiMonorepo.expect(localStorage.getItem("prop1")).equal(
            "red"
          );
          Cypress$IsenseiMonorepo.expect(localStorage.getItem("prop2")).equal(
            "blue"
          );
          Cypress$IsenseiMonorepo.expect(localStorage.getItem("prop3")).equal(
            "magenta"
          );
        })
        .then(function (param) {
      ...
      cy.get(".ls-btn", undefined)
        ...
        .then(function (param) {
          cy.clearLocalStorage(
            Cypress$IsenseiMonorepo.LocalStorageOptions.make(
              undefined,
              undefined
            )
          ).should(function (ls) {
